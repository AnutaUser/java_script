...
usersList.forEach(user => {
    ...
    h3Username.innerText = user.username;

    let pEmail= document.createElement('p');
    pEmail.innerText = user.email;

    let divAddress = document.createElement('div');
    user.address.forEach(adds => {
        let userAdd = document.createElement('div');
        userAdd.innerText = adds;
        divAddress.appendChild(userAdd);
    });
    ...
    // for (const company of user.company) {
    //     let companyElement = document.createElement('div');
    //     companyElement.innerText = company;
    //
    //     divCompany.appendChild(companyElement);
    // }


    divElement.append(divId, h3Name, h3Username, pEmail, divAddress, divPhone, divWebsite, divCompany);
